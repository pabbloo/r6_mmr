<!DOCTYPE html>
<html lang="pl-PL" style="font-family: 'Lato', sans-serif;">
  <head>
    <meta charset="utf-8">
	...
	<p style="color:grey;right:20px;position:absolute">v1.8.2<br><i>by pabbloo<br>2020</i></p>
<link href="https://fonts.googleapis.com/css2?family=Lato&display=swap" rel="stylesheet">
<link rel="shortcut icon" href="https://static-dm.akamaized.net/siege/prod/favicon.ico"/>
  </head>
  <body>
<div id="tabelka" style="position:absolute;width:700px;height:380px">
	...
	<tr>
		<th>Nick</th>
		<th>MMR</th>
		<th colspan="2">Ranga</th>
		<th colspan="2" style="font-size:10pt">Ostatnia zmiana MMR</th>
	</tr>
	<tr>
		<th>maIcher8</th>
		<th id="maIcher8" ></th>
...
-->	
	...
	<p id="update_t">Trwa aktualizacja danych...</p>
</div>
<div id="divprzycisk" style="position:absolute;width:800px;height:380px;top:0px;left:700px;padding:10px;">
	<table style="border: 0px;text-align:left" id="druga">
		<tr>
			<th style="font-size:12pt; width: 400px;height:340px;font-weight: normal;">
			<h3>Witam w kolejnym sezonie tej zajebistej gierki.</h3>
			...
			<br><br>
			<b id="diff">Sprawdzanie różnic...</b>
			<br><br><br>Dane nieaktualne?<br>
			<button style="font-size:20pt;" id="guzik" title="Nie można za często odświeżać">Zaktualizuj dane</button>
			</th>
			<th style="font-size:12pt; width: 400px;height:340px;font-weight: normal;padding:0px">
				<center><div id="memik"></div></center>
			</th>
		</tr>
		<tr>
			<th></th>
		<th style="font-size:12pt;font-weight: normal;padding:0px"><center> Mem dnia </center></th>
		</tr>
	</table>
...
<script type="text/javascript">
	function wypelnij_tabele () {
		...
		if (roznica <= 1000) {
			...
			var txt = max_nick+" nie może grać z " +  min_nick + ". Róznica: " + roznica;
		...
		]},
{
		...
		<?php
				...
				while($row = mysqli_fetch_array($result)) {
					...
					echo"{ x: new Date(".$rok.", ".$mm.", ".$dzien.", ".$godzina.", ".$minuta."), y: 2100 },";
				}
...
window.onload = function () {
		...
		guzik.onclick=function(){updt()}
}		
</script>

<div id="chartContainer" style="top:400px;height:500px; width: 90%;position:absolute"></div>
  </body>
</html>
